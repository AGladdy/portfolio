    ...
    <>
      ...
      <main className="min-h-screen bg-bg pt-24 pb-32">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <Link
            href="/#projects"
            className="inline-flex items-center gap-2 font-sans text-[10px] tracking-[0.25em] uppercase text-muted hover:text-accent transition-colors duration-200 mb-12 group"
          >
            <FiArrowLeft
              size={12}
