    ...
    sections: [
      ...
      },
      {
        ...
        videos: [
          ...
          '/assets/nav-cf-vsmedicine-whynavage.png',
          '/assets/nav-cf-usageoccasion-manage.mp4',
          '/assets/nav-usage-occasion-stayahead.png',
          '/assets/nav-removes99-wave10.mp4',
          '/assets/nav-cf-vsmedicine-sleepchart.png',
          '/assets/nav-vsnf-beginners.mp4',
          '/assets/nav-cf-efficacy-snoreless.png',
          '/assets/nav-review1-wave10.mp4',
          '/assets/nav-value-promo.mp4',
        ],
      },
    ],
  },
